...
export default function AddLocation() {
  ...
  const addLocation = (e) => {
    ...
    formData.append("file4", video);
    axios
      .post(`/uploadI`, formData)
      .then((res) => {
        let arr = [];
        if (image3) {
        ...
        const location = {
          ...
          space,
          images: arr,
          video: res.data.file4,
        };
        axios
          .post(`/AddApartment/${userCon?.id}`, location)
          .then((res) => {
                ...
                <form action='#'>
                  <div className='ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center'>
                    <div className='nav'>
                      ...
                      <a data-bs-toggle='tab' href='#liton_tab_3_2' className>
                        2. Photo/Video
                      </a>
